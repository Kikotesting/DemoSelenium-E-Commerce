...
public class DressesMenuTests extends BaseTest {
    ...
    void verifyAddProductInShoppingCart_TC1(){
        ...
        // Go to Shopping cart page and check table with added product
    ...
    @Test
    @Order(2)
    @DisplayName("Add product to shopping cart and proceed to checkout")
    void verifyCheckoutInShoppingCart_TC2(){
        homePage = new HomePage(driver);
        dressPage = new DressesPage(driver);
        shopCartPage = new ShoppingCartPage(driver);
        alertPage = new AlertPage(driver);
